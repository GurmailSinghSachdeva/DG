...
public class Constants {
    ...
    public static String urlOnline = "discountgali.com/ViewAllOnlineDeals.aspx?CompanyId=";
    public static String urlOffline = "discountgali.com/DealDetails.aspx?DealId=";
