...
import com.gurmail.singh.discountgali.myviews.MyJsonObject;
...
//                    deal.icon = object.getString("ImageUrl");
                    ...
                    deal.dealId = 0;
                    if(deal.redirect_url.contains(Constants.urlOffline))
                    {
                        deal.isOnloine = false;
                        try{
                            deal.dealId = Integer.parseInt(deal.redirect_url.split("=")[1]);
                        }catch (Exception e)
                        {
                            deal.dealId = 0;
                        }
                    ...
                    if(deal.redirect_url.contains(Constants.urlOnline))
                    {
                        deal.isOnloine = true;
                        try{
                            deal.dealId = Integer.parseInt(deal.redirect_url.split("=")[1]);
