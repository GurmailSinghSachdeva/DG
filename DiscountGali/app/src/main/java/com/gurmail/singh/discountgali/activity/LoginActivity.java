...
import com.gurmail.singh.discountgali.network.apicall.LoginApiCall;
import com.gurmail.singh.discountgali.utility.AlertUtils;
...
//                break;
    ...
    private void verificationApiCall(String otp) {
        try{
            ...
            progressDialog.show();
            apiCall = new LoginApiCall(et_phone_number.getText().toString().trim(), et_ref.getText().toString().trim(), 1 , otp);
...
//                                        finish();
                                        ...
                                        AlertUtils.showToast(LoginActivity.this, !TextUtils.isEmpty(baseModel.Message)?
                                        baseModel.Message : "Login Error. Please try again after some time");
                                    }
                                    break;
                                default:
                                    DialogUtils.showAlert(LoginActivity.this, !TextUtils.isEmpty(baseModel.Message)?baseModel.Message:"Login error. please try again");
